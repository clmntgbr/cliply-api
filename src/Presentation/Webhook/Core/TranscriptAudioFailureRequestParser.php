...
final class TranscriptAudioFailureRequestParser extends AbstractRequestParser
{
    public const string WEBHOOK_NAME = 'transcriptaudiofailure';
    ...
    protected function doParse(Request $request, #[SensitiveParameter] string $secret): RemoteEvent
    {
        ...
        try {
            ...
            $data = $this->denormalizer->denormalize($payload->all(), TranscriptAudioFailure::class);
        } catch (Exception) {
